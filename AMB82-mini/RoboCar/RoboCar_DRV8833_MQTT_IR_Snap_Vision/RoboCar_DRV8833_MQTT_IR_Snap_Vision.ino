...
GenAI llm;
GenAI tts;
String API_KEY = "AIzaSyCIjtHuBJpeNOScPwg0JuABQtGV3AHHWUU"; 

#define CHANNEL  0
String imgfile = "image.jpg";
String mp3file = "mp3/JarOfLove.mp3";
String mp3Filename = "google_tts.mp3";
...
void callback(char* topic, byte* payload, unsigned int length)
{
    ...
    // list files under root directory
      ...
      String text = llm.geminivision(API_KEY, "gemini-2.5-flash", prompt_msg, img_addr, img_len, client); 
      Serial.println(text);
      tts.googletts(mp3Filename, text, "en-US"); // zh-TW
      delay(500);
